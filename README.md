...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Xá»­ lÃ½ thÃ´ng bÃ¡o ÄÄng kÃ½ thÃ´ng minh báº±ng tÃªn trinh
    ...
    if (registerForm) {
        registerForm.addEventListener("submit", function(e) {
            ...
            if (targetInput && targetInput.value.trim() !== "") {
                alert(`ð ChÃºc má»«ng "${targetInput.value.trim()}" ÄÃ£ gia nháº­p vÃ  kÃ­ch hoáº¡t thÃ nh viÃªn thÃ nh cÃ´ng trÃªn VeloSport!`);
            }
        });
    }
});
